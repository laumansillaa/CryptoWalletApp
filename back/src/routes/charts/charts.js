...
module.exports = async function(req, res, next) {
    ...
    const coins = [{coin: "BTC", id: "bitcoin"}, {coin: "ETH", id: "ethereum"}, {coin: "BNB", id: "binancecoin"}, {coin: "SOL", id: "solana"}, {coin: "ADA", id: "cardano"}, {coin: "XRP", id: "ripple"}, {coin: "LUNA", id: "terra-luna"}, {coin: "DOT", id: "polkadot"}, {coin: "AVAX", id: "avalanche-2"}, {coin: "DOGE", id: "dogecoin"}, {coin: "1000SHIB", id: "shiba-inu"}, {coin: "MATIC", id: "matic-network"}, {coin: "LINK", id: "chainlink"}, {coin: "LTC", id: "litecoin"}, {coin: "ALGO", id: "algorand"}, {coin: "XLM", id: "stellar"}, {coin: "NEAR", id: "near"}, {coin: "ATOM", id: "cosmos"}]
    try {
